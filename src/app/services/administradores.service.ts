...
export class AdministradoresService {
  ...
  public obtenerListaAdmins(page: number, pageSize: number, sort: string, search: string): Observable<any> {
    const token = this.facadeService.getSessionToken();
    let headers: HttpHeaders;
    ...
    return this.http.get<any>(`${environment.url_api}/lista-admins/`, { headers, params });
  }
